...
intermedia.fengOffice.client.Api.prototype.defaultOnError = function(err) {
	haxe.Log.trace("Error (API default error handler) : " + Std.string(err),{ fileName : "Api.hx", lineNumber : 26, className : "intermedia.fengOffice.client.Api", methodName : "defaultOnError"});
}
...
intermedia.fengOffice.client.widgets.FOObjectDetail.prototype._displayItem = function(itemDetail) {
	...
	haxe.Log.trace("***********************<br/>",{ fileName : "FOObjectDetail.hx", lineNumber : 40, className : "intermedia.fengOffice.client.widgets.FOObjectDetail", methodName : "_displayItem"});
	haxe.Log.trace("Details of " + this._item.name + ": " + itemDetail + "<br/>",{ fileName : "FOObjectDetail.hx", lineNumber : 41, className : "intermedia.fengOffice.client.widgets.FOObjectDetail", methodName : "_displayItem"});
	{
		var _g = 0, _g1 = Reflect.fields(itemDetail);
		while(_g < _g1.length) {
			var prop = _g1[_g];
			++_g;
			haxe.Log.trace(prop + " = " + Reflect.field(itemDetail,prop) + "<br/>",{ fileName : "FOObjectDetail.hx", lineNumber : 43, className : "intermedia.fengOffice.client.widgets.FOObjectDetail", methodName : "_displayItem"});
		}
	}
	haxe.Log.trace("*********************** properties:<br/>",{ fileName : "FOObjectDetail.hx", lineNumber : 45, className : "intermedia.fengOffice.client.widgets.FOObjectDetail", methodName : "_displayItem"});
	{
		var _g = 0, _g1 = Reflect.fields(itemDetail.properties);
		while(_g < _g1.length) {
			var prop = _g1[_g];
			++_g;
			haxe.Log.trace(prop + " = " + Reflect.field(itemDetail.properties,prop) + "<br/>",{ fileName : "FOObjectDetail.hx", lineNumber : 47, className : "intermedia.fengOffice.client.widgets.FOObjectDetail", methodName : "_displayItem"});
		}
	}
	haxe.Log.trace("***********************<br/>",{ fileName : "FOObjectDetail.hx", lineNumber : 49, className : "intermedia.fengOffice.client.widgets.FOObjectDetail", methodName : "_displayItem"});
...
intermedia.fengOffice.client.widgets.FOObjectDetail.prototype.refresh = function(event) {
	...
	haxe.Log.trace("call getObject(" + this._item.id,{ fileName : "FOObjectDetail.hx", lineNumber : 85, className : "intermedia.fengOffice.client.widgets.FOObjectDetail", methodName : "refresh"});
...
intermedia.fengOffice.client.widgets.FOObjectsList.prototype._displayItems = function(items) {
	...
	if(this.onLoading != null) this.onLoading(false);
	haxe.Log.trace("Items: " + items,{ fileName : "FOObjectsList.hx", lineNumber : 44, className : "intermedia.fengOffice.client.widgets.FOObjectsList", methodName : "_displayItems"});
...
intermedia.fengOffice.client.widgets.FOObjectsList.prototype.refresh = function(event) {
	...
	if(this.onLoading != null) this.onLoading(true);
	this._widget.startTransition();
	haxe.Log.trace("call listMembers(" + intermedia.fengOffice.client.application.AppState.getInstance().curServiceType + ", " + curId + ", " + intermedia.fengOffice.client.application.AppState.getInstance().curWorkspace.id + ", -1",{ fileName : "FOObjectsList.hx", lineNumber : 117, className : "intermedia.fengOffice.client.widgets.FOObjectsList", methodName : "refresh"});
...
intermedia.fengOffice.client.widgets.FOObjectsList.prototype.enableUp = function() {
	haxe.Log.trace("upBtn enabled " + this._id,{ fileName : "FOObjectsList.hx", lineNumber : 123, className : "intermedia.fengOffice.client.widgets.FOObjectsList", methodName : "enableUp"});
	try {
...
intermedia.fengOffice.client.widgets.FOObjectsList.prototype.disableUp = function() {
	haxe.Log.trace("upBtn disabled " + this._id,{ fileName : "FOObjectsList.hx", lineNumber : 129, className : "intermedia.fengOffice.client.widgets.FOObjectsList", methodName : "disableUp"});
	try {
...
intermedia.fengOffice.client.application.Application.prototype.displayError = function(msg) {
	if(this.widget != null) {
		...
		haxe.Log.trace("Error : " + msg,{ fileName : "Application.hx", lineNumber : 87, className : "intermedia.fengOffice.client.application.Application", methodName : "displayError"});
	}
}
intermedia.fengOffice.client.application.Application.prototype.onAuth = function(user) {
	if(user.error_msg != "") {
		haxe.Log.trace("authentication failed",{ fileName : "Application.hx", lineNumber : 92, className : "intermedia.fengOffice.client.application.Application", methodName : "onAuth"});
		this.goAuthPage(user.error_msg);
		return;
	}
	intermedia.fengOffice.client.Input.initPhoneGap();
	haxe.Log.trace("authentication success " + user.token,{ fileName : "Application.hx", lineNumber : 97, className : "intermedia.fengOffice.client.application.Application", methodName : "onAuth"});
...
intermedia.fengOffice.client.application.Application.prototype.goList = function(srv) {
	...
	haxe.Log.trace("List selected " + srv,{ fileName : "Application.hx", lineNumber : 117, className : "intermedia.fengOffice.client.application.Application", methodName : "goList"});
...
intermedia.fengOffice.client.application.Application.prototype.goDetail = function(srv,item) {
	...
	haxe.Log.trace("Show detail of " + item,{ fileName : "Application.hx", lineNumber : 140, className : "intermedia.fengOffice.client.application.Application", methodName : "goDetail"});
	intermedia.fengOffice.client.application.AppState.getInstance().curServiceType = srv;
...
intermedia.fengOffice.client.application.Application.prototype._onSelectItem = function(item) {
	haxe.Log.trace("item selected: " + item,{ fileName : "Application.hx", lineNumber : 148, className : "intermedia.fengOffice.client.application.Application", methodName : "_onSelectItem"});
