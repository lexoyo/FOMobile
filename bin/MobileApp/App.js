...
intermedia.fengOffice.client.widgets.FOObjectsList.prototype._displayItems = function(items) {
	...
	while( $it0.hasNext() ) {
		var w = $it0.next();
		var w1 = [w];
		js.Lib.document.getElementById("itemBtn" + this._id + w1[0].id).onclick = (function(w1) {
			return function(e) {
				t1.openItem(w1[0]);
			};
		})(w1);
		js.Lib.document.getElementById("selectBtn" + this._id + w1[0].id).onclick = (function(w1) {
			return function(e) {
				t1.selectItem(w1[0]);
			};
		})(w1);
...
intermedia.fengOffice.client.application.Application.prototype.onAuth = function(user) {
	if(user.error_msg != "") {
		haxe.Log.trace("authentication failed",{ fileName : "Application.hx", lineNumber : 57, className : "intermedia.fengOffice.client.application.Application", methodName : "onAuth"});
		this.goAuthPage(user.error_msg);
		return;
	}
	intermedia.fengOffice.client.Input.initPhoneGap();
	haxe.Log.trace("authentication success " + user.token,{ fileName : "Application.hx", lineNumber : 62, className : "intermedia.fengOffice.client.application.Application", methodName : "onAuth"});
...
intermedia.fengOffice.client.application.Application.prototype.goList = function(srv) {
	...
	haxe.Log.trace("List selected " + srv,{ fileName : "Application.hx", lineNumber : 79, className : "intermedia.fengOffice.client.application.Application", methodName : "goList"});
...
intermedia.fengOffice.client.application.Application.prototype.goDetail = function(srv,item) {
	...
	haxe.Log.trace("Show detail of " + item,{ fileName : "Application.hx", lineNumber : 101, className : "intermedia.fengOffice.client.application.Application", methodName : "goDetail"});
	intermedia.fengOffice.client.application.AppState.getInstance().curServiceType = srv;
...
intermedia.fengOffice.client.application.Application.prototype._onSelectItem = function(item) {
	haxe.Log.trace("item selected: " + item,{ fileName : "Application.hx", lineNumber : 110, className : "intermedia.fengOffice.client.application.Application", methodName : "_onSelectItem"});
